    ...
    <div className="fixed bottom-5 right-5 z-[1000]">
        ...
        <div className="bg-blue-500 text-white py-4 px-5 flex flex-col items-center justify-center rounded-t-[15px] relative">
          ...
          <div className="flex space-x-2 absolute top-1/2 right-3 transform -translate-y-1/2">
            {window.innerWidth > 768 && (
              <button
                className="bg-none border-none text-white cursor-pointer transition-colors duration-300 ease-in-out hover:text-green-500"
      ...
      <div
        className={`bg-blue-500 text-white rounded-full p-3 cursor-pointer shadow-lg 
          ...
          hover:bg-blue-700 ${isOpen ? 'opacity-0 invisible' : 'opacity-100 visible'}`}
        onClick={toggleChatbot}
      >
        <FaComments size={24} />
      </div>
