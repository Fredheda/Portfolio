...
class PromptManager:
    ...
    def update_messages_with_toolcalls(self, messages: list, tool_name: str, argument: str, tool_call_content: str) -> list:
        """
        Updates the messages list with tool calls.

        Args:
            messages (list): The list of messages to be updated.
            tool_name (str): The name of the tool being called.
            argument (str): The argument passed to the tool.
            tool_call_content (str): The content generated by the tool call.

        Returns:
            list: The updated list of messages with the tool call included.
        """

        tool_messages = self.prompts["tool_base_prompt"].format(tool_name=tool_name, argument=argument, tool_call_content=tool_call_content)
        messages.append({"role": "assistant", "content": tool_messages})
